...
<div class="recipes-list">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="recipes/meatballs.php"><img src="resources/images/Turkey-meatballs.jpg"
                                                         alt="Meatballs page"></a>
                    <div class="other-recipes"><h4>Turkey Meatballs</h4></div>
                </div>
                <div class="thumbnail">
                    <a href="recipes/pancakes.php"><img src="resources/images/AppleOatPancakes_DT.jpg"
                                                        alt="Pancakes page"></a>
