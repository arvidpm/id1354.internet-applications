    ...
    <div class="grid-calendar">
        ...
        <div class="row calendar-week">
            <div class="col-xs-1 grid-cell"><a href="">
                    <img class="img-responsive" src="<?php echo base_url('resources/images/ultimate_BLT_sandwich-square.jpg')?>" alt="Gorgeous BLT Sandwich"></a></div>
        ...
        <div class="row calendar-week">
            <div class="col-xs-1 grid-cell"><a href="">
                    <img class="img-responsive" src="<?php echo base_url('resources/images/icecream-square.jpg')?>" alt="Delicious Icecream"></a></div>
